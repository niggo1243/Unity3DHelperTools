...
{
    /// <summary>
    /// A wrapper class for <see cref="MonoBehaviour"/> <see cref="Interfaces.IId"/> or <see cref="Interfaces.IIdList"/> implementations
    /// providing iD match checks
    /// </summary>
    public abstract class BaseIdMono : BaseNotesMono
    {
        [SerializeField]
